...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { category: @habit.category, description: @habit.description, start_date: @habit.start_date, title: @habit.title } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { category: @habit.category, description: @habit.description, start_date: @habit.start_date, title: @habit.title } }
